...
function App() {
 ...
 <p>Total Simple Interest</p>
      ...
      <div className='mt-4'>
        ...
        <br />
        <br />
        <TextField id="outlined-basic" label="Rate of interest(pa)%" variant="outlined"  onChange={(e)=>validate(e)} value={intrest} name='intrestie'/>
        {
            !isintrest&&
            <div>
              <p className='text-danger'>Invalid Amount</p>
        ...
        <br />
        <br />
        <TextField id="outlined-basic" label="Year" variant="outlined" onChange={(e)=>validate(e)} value={yeare} name="yr"/>
        {
            !isyr&&
            <div>
              <p className='text-danger'>Invalid Amount</p>
